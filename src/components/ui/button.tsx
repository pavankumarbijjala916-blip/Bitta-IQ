  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-250 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        success: "bg-status-healthy text-primary-foreground hover:opacity-90 shadow-sm hover:shadow-md active:scale-[0.98]",
        warning: "bg-status-repairable text-primary-foreground hover:opacity-90 shadow-sm hover:shadow-md active:scale-[0.98]",
        danger: "bg-status-recyclable text-primary-foreground hover:opacity-90 shadow-sm hover:shadow-md active:scale-[0.98]",
      },
      size: {
